...
import doneAnimation from "./pretest.json"; // animasi success

export default function PretestDoneSection() {
      ...
      <div className="grid md:grid-cols-2 gap-7 items-center relative z-10">
        ...
        >
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            Terima kasih! Anda telah menyelesaikan pretest sebelumnya.
          ...
          >
            <p className="text-green-700 font-semibold">
              ✅ Pre Test berhasil tersimpan
            </p>
            <p className="text-green-600 text-sm mt-1">
              Anda dapat melanjutkan ke materi pembelajaran
            </p>
          </motion.div>
