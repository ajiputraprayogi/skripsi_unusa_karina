...
import pretestAnimation from "./pretest.json";

interface PretestSectionProps {
  email: string;
}

export default function PretestSection({ email }: PretestSectionProps) {

  const GOOGLE_FORM_URL =
    "https://forms.gle/siCk8D3BDXTYpKF27";
  ...
  return (
      ...
      <div className="grid md:grid-cols-2 gap-7 items-center relative z-10">
        ...
        >
          <Lottie
            animationData={pretestAnimation}
            loop
            autoplay
        ...
        >
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            ...
            perkembangan anak Anda. Hasil pretest akan membantu memberikan 
